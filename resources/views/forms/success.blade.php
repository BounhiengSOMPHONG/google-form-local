            ...
            <div class="container mx-auto px-4 py-8 max-w-3xl">
                <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 text-center">
                    ...
                    <div class="flex items-center justify-center space-x-4">
                        ...
                        @if($respId)
                            <a href="{{ route('forms.public', $form->id) }}?response_id={{ $respId }}#edit" class="inline-block bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded">แก้ไขคำตอบของคุณ</a>
                        @else
                            <a href="{{ route('forms.public', $form->id) }}#edit" class="inline-block bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded">แก้ไขคำตอบของคุณ</a>
                        @endif
                    </div>
                </div>
            </div>
