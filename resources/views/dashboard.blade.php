    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
            <div>
                ...
                <p class="text-gray-600 text-sm mt-1">Manage your surveys and forms</p>
            </div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-medium text-gray-900">{{ $surveys->count() }}</h3>
            ...
            <div class="mb-12">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-lg font-medium text-gray-900">{{ __('My Surveys') }}</h3>
                    <a href="{{ route('surveys.index') }}" class="text-sm text-blue-600 hover:text-blue-800">{{ __('View All') }}</a>
                </div>
                            ...
                            <div class="bg-white border rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
                                <div class="p-4">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span class="px-2 py-1 text-xs {{ $survey->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800' }} rounded-full">
